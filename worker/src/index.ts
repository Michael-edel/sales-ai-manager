...
ГДЕ
  ...
  И Договоры.Партнер = &СсылкаПартнера
УПОРЯДОЧИТЬ ПО
...
ГДЕ
  ...
  И Заказы.Партнер = &СсылкаПартнера
УПОРЯДОЧИТЬ ПО
  Заказы.Дата УБЫВ
`,
  },
...
ГДЕ
  ...
  И Соглашения.Партнер = &СсылкаПартнера
УПОРЯДОЧИТЬ ПО
...
const ONEC_CLIENT_ADDRESS_QUERIES = [
  {
    key: "partner_contact_information_by_ref",
    query: `
ВЫБРАТЬ ПЕРВЫЕ 30
  КонтактнаяИнформация.Объект КАК Партнер,
...
ГДЕ
  КонтактнаяИнформация.Объект = &СсылкаПартнера
УПОРЯДОЧИТЬ ПО
  КонтактнаяИнформация.Вид
`,
  },
  {
    key: "contact_information_register",
    query: `
ВЫБРАТЬ ПЕРВЫЕ 30
...
ИЗ
  РегистрСведений.КонтактнаяИнформация КАК КонтактнаяИнформация
ГДЕ
  КонтактнаяИнформация.Объект.Наименование ПОДОБНО &Поиск
  ИЛИ КонтактнаяИнформация.Объект.НаименованиеПолное ПОДОБНО &Поиск
УПОРЯДОЧИТЬ ПО
  КонтактнаяИнформация.Вид
`,
  },
  {
    key: "counterparty_addresses",
    query: `
ВЫБРАТЬ ПЕРВЫЕ 20
  Контрагенты.Ссылка КАК Контрагент,
  Контрагенты.Наименование КАК Наименование,
...
`,
  ...
  {
    key: "partners_contact_information",
    query: `
ВЫБРАТЬ ПЕРВЫЕ 30
  КонтактнаяИнформация.Объект КАК Партнер,
  КонтактнаяИнформация.Вид КАК Вид,
