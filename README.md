...
- Автоматическая read-only проверка 1С перед отправкой заявки в ИИ: программа добавляет в исходный текст блок `Автоматическая проверка 1С` с найденным клиентом, товаром, остатками и ценами, если bridge доступен и в заявке есть поисковые признаки.
