...
- заголовок справа: `Приложение №____ от ... к Договору поставки № 71-02-26/СН от 17 февраля 2026 года`;
...
- ширина таблицы ограничена под лист A4, длинные коды и наименования переносятся внутри ячеек;
...
- подписи сторон расположены отдельно в колонках покупателя и поставщика, а строки `Директор` выровнены на одном уровне; поставщик подписывается как `Эйрих М.М.`.
