...
- Панель read-only проверок 1С в интерфейсе администратора:
  ...
  - `Проверить остатки и цены` — чтение свободных остатков и последних цен номенклатуры.
