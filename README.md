...
8. Если отправитель точно не присылает заявки, отметьте галочку «Не показывать письма от этого отправителя». Адрес попадет в список скрытых отправителей, и письма от него больше не будут отображаться в рабочих папках. Блок «Скрытые отправители» по умолчанию свернут; восстановить адрес можно после раскрытия блока кнопкой «показывать».
