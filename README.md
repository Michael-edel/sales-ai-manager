...
9. Если почтовый список мешает работе с заявкой, нажмите «Свернуть почту» в заголовке блока. Список писем, вкладки и фильтры полностью скроются до нажатия «Показать почту».
