...
- `manager` — рабочий доступ менеджера: обработка заявок, проверка почты, изменение статусов, документы сделки и задачи.
- `accountant` — доступ бухгалтерии: просмотр заявок, документы сделки и задачи; создание AI-обработок и проверка почты недоступны.
